...
impl ExpenseImportProcessor {
    ...
    pub async fn process(&self, sheet: &Sheet, mapping: ColumnMapping, user_id: Uuid) -> Result<ImportResult, String> {
        ...
        for row in 1..=max_row {
            ...
            match self.process_row(sheet, &mapping, row, user_id).await {
    ...
    async fn process_row(&self, sheet: &Sheet, mapping: &ColumnMapping, row: u32, user_id: Uuid) -> Result<(), String> {
