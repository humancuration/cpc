...
//! on cause impact visualizations.
...
/// Feedback collector for cause impact visualizations
...
mod tests {
    ...
    fn test_collect_detailed_feedback() {
        ...
        let result = collector.collect_detailed_feedback(
            ...
            true,
            Some("Helped me understand the cause better".to_string()),
            Some(8),
            Some(9),
        );
        assert!(result.is_ok());
    ...
    fn test_feedback_processor() {
        let feedback_data = vec![VisualizationFeedback {
            ...
            viz_id: "cause_viz_1".to_string(),
            rating: 5,
            comment: Some("Great visualization!".to_string()),
            helpful: true,
            decision_impact: Some("Helped me decide to contribute to this cause".to_string()),
