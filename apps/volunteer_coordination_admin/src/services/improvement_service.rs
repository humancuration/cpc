//! Improvement service for the volunteer coordination admin dashboard
//!
//! This service provides access to improvement suggestions from the volunteer_impact_tracker crate.

use volunteer_impact_tracker::improvement::{ImprovementEngine, AutoImprovementSuggestion};
use volunteer_impact_tracker::analytics::DashboardSummary;
use volunteer_impact_tracker::feedback::FeedbackProcessingResult;
