-- DEPRECATED: This migration has been moved to apps/backend/migrations/
-- This file remains for historical reference per project policy (no file deletion)
-- All future database changes should use the backend migration directory

-- This file has been moved to apps/backend/migrations/20250726000000_create_website_builder_tables.sql
